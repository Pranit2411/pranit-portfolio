    ...
    <div
      ...
      <div ref={ref} className="relative pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                className="h-10 absolute w-10 rounded-full bg-midnight flex items-center justify-center -left-[15px]">
                <div
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[2px] bg-gradient-to-b from-transparent via-neutral-700 to-transparent ">
        </div>
      </div>
    </div>
  );
